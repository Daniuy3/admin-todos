...
import { addProduct, decreaseProduct } from "../actions/actions";
...
export const ItemCard = ({ product, quantity }: Props) => {
  ...
  function onRemoveItem() {
    if (!(optimisticQuantity === 0)) setOptimisticQuantity(optimisticQuantity - 1);
  ...
  return (
    <div className="flex items-center shadow rounded-lg w-full bg-gray-800 border-gray-100">
      ...
      <div className="px-5 pb-5 w-full flex flex-col mt-2">
        ...
        <div className="flex flex-col items-start justify-between">
          ...
          <span className="font-bold text-white">
            Total: ${ (product.price * optimisticQuantity).toFixed(2) }
          </span>
      ...
      <div className="flex p-5 items-center justify-center">
        ...
        <span className="text-2xl text-white mx-10">{optimisticQuantity}</span>
        <button
